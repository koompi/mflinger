 ...
 *
 * To have a stable layerstack for pionux, we have DMS reserve
...
static int32_t get_layer(int32_t surface_idx)
{
     ...
     * sure pionux surfaces are the topmost layers.
     *
                         ...
                         uint32_t w, uint32_t h)
{
    ...
    String8 name = String8::format("pionux %d", state->num_surfaces);
